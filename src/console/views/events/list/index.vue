    ...
    <Row>
      <Col :span="7">
        <div class="margin-bottom-10">
          ...
          <div style="display: none"><img id="exportedImageEvent" /></div>
        </div>
...
export default {
  ...
  methods: {
    ...
    exportImage() {
      ...
      html2canvas(table, {
        ...
        onrendered(image) {
          ...
          document.getElementById('exportedImageEvent').src = url;
    ...
    edit(data) {
      if (data) {
        localStorage.eventTitle = data.title;
        localStorage.eventContent = data.content;
        localStorage.eventCover = data.cover;
